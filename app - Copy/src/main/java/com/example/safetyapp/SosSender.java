...
public class SosSender {
    ...
    public static String buildMessage(String location) {
        String mapsLink = location.equals("Location unavailable")
                ? "GPS unavailable"
    ...
    public static void sendSmsToAll(Context ctx, String location) {
    ...
    public static void sendWhatsAppToAll(Context ctx, String location) {
        List<SosContact> contacts = ContactManager.loadContacts(ctx);
